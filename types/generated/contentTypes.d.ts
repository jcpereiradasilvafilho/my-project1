...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    crm: Attribute.String & Attribute.Required;
    data_nascimento: Attribute.Date & Attribute.Required;
    estado_civil: Attribute.Enumeration<
    ...
    certidao: Attribute.Media;
    especializacao: Attribute.Media;
    rqe: Attribute.Integer;
    chave_pix: Attribute.String;
    banco: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToOne',
      'api::banco.banco'
    >;
...
export interface ApiBancoBanco extends Schema.CollectionType {
...
export interface ApiDividendoDividendo extends Schema.CollectionType {
  ...
  attributes: {
    ...
    lotacao: Attribute.Relation<
      ...
      'api::lotacao.lotacao'
    >;
    numero_nota_fiscal: Attribute.String & Attribute.Required;
    data_emissao_nota: Attribute.Date & Attribute.Required;
    data_inclusao: Attribute.Date;
    ...
    banco_emissor: Attribute.Relation<
      ...
      'api::banco.banco'
    >;
    banco_receptor: Attribute.Relation<
      'api::dividendo.dividendo',
      'oneToOne',
      'api::banco.banco'
    >;
...
export interface ApiEmpresaEmpresa extends Schema.CollectionType {
  ...
  attributes: {
    nome: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'he value does not match the regex.'>;
    representante: Attribute.String;
    logradouro: Attribute.String;
    bairro: Attribute.String;
    cidade: Attribute.String;
    estado: Attribute.String;
...
export interface ApiEspecialidadeEspecialidade extends Schema.CollectionType {
...
export interface ApiLotacaoLotacao extends Schema.CollectionType {
  collectionName: 'lotacaos';
  info: {
    singularName: 'lotacao';
    pluralName: 'lotacaos';
    displayName: 'lotacao';
    description: '';
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::dividendo.dividendo': ApiDividendoDividendo;
      ...
      'api::lotacao.lotacao': ApiLotacaoLotacao;
    }
  }
}
